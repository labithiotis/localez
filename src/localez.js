...
function Locale(locale) {
    ...
    this.options = extend({
        ...
        numbers: function (number, gender) {
            if (!number || number <= 0) return this.options.numbersEnums.zero;
            var b = number % 10;
            return (~~(number % 100 / 10) === 1) ? this.options.numbersEnums.many :
                (b === 1) ? this.options.numbersEnums.one :
                (b === 2) ? this.options.numbersEnums.two :
                (b === 3) ? this.options.numbersEnums.few : this.options.numbersEnums.other;
        },
        numberToString: function (n, gender) {
            if (n === 0) return 'zero';
...
if (typeof module !== 'undefined') {
    ...
    module.exports = exports =  new Locales()
