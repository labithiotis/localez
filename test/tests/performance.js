...
describe('Performance Tests', function() {
		...
		it('Doing 10,000 basic queries', function(done) {
			...
			if (time > 20) throw new Error('Time to process 10,000 queries took over 20ms, it took: ' + time + 'ms')
		...
		it('Doing 1,000 complex queries', function(done) {
			...
			if (time > 50) throw new Error('Time to process 1,000 queries took over 50ms, it took: ' + time + 'ms')
